...
public class WatcherController {
  ...
  public HttpEntity<Watcher> getWatcher(
    ...
    if (!user.getId().equals(watcher.getUserid())) watcher.setId(null);
  ...
  public HttpEntity<Watcher> updateWatcher(
    ...
    if (newWatcherData.getUserid() != null
        && !newWatcherData.getUserid().equals(watcher.getUserid())) {
  ...
  private User ensureLoggedIn(Map<String, String> requestHeaders) {
    ...
    if (executingUser == null) throw new UnauthorizedException();

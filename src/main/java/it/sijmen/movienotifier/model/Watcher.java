...
public class Watcher implements Model {
  ...
  @NotBlank @JsonProperty private String userid;
  ...
  @JsonProperty @Valid @NotNull @ModelUpdater.RecursiveUpdate private WatcherFilters filters;
